...
// const {mikee, caroll:{marciaa}} = bradys
// //const {mike, carol:{marcia}} = bradys
// console.log(mikee, caroll, marciaa)
// console.log(bradys)
...
//const {name, color, album:{song1, song_2, song3, song_4}, k_job, k_partner} = k_muppet.k_album.the_muppet_movie
//const {, , album:{, song_2, , song_4}, k_job, k_partner} = k_muppet.k_album.the_muppet_movie
//const [, , { , song_2, , song_4}, k_job, k_partner] = k_muppet.k_album.the_muppet_movie
//const {,,{{, song_2, , song_4} k_job, k_partner}} = k_muppet{,,{{,song_2,,song_4}}k_job, k_partner}